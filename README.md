...
1. **Base de Datos:** Crear una base de datos en MySQL llamada **db\_rrhh** (el repositorio cuenta con **createDatabaseIfNotExist=true** en **application.properties** para crear la base de datos si no existe).
